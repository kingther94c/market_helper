...
STRUCTURE_ZERO_COST_COLLAR = "ZERO_COST_COLLAR"   # buy OTM put-spread, finance with an OTM short call
STRUCTURE_CALL_SPREAD = "CALL_SPREAD"
STRUCTURE_PUT_SPREAD = "PUT_SPREAD"
STRUCTURE_CARRY_SHORT_CALL = "CARRY_SHORT_CALL"   # naked short call — premium carry (MONITOR-capped)
STRUCTURE_CARRY_SHORT_PUT = "CARRY_SHORT_PUT"     # short put — premium carry (MONITOR-capped)
