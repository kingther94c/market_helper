...
def build_parser() -> argparse.ArgumentParser:
    ...
    etf_sector_sync.add_argument(
        "--api-key",
        required=False,
        help="Optional Alpha Vantage API key. Falls back to ALPHA_VANTAGE_API_KEY env var or local.env (auto-derived from MARKET_HELPER_GDRIVE_ROOT or the repo default).",
    )
    ...
    fred_macro_sync.add_argument(
        "--api-key",
        default=None,
        help="Optional FRED API key. Falls back to FRED_API_KEY env var or local.env (auto-derived from MARKET_HELPER_GDRIVE_ROOT or the repo default).",
    )
